"""
Django settings for runkstripe project.
...
ALLOWED_HOSTS = ['127.0.0.1:8000', 'git.heroku.com/ranks-test.git']
...
WSGI_APPLICATION = 'runkstripe.wsgi.application'
